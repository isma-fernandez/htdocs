...
}else
{
    ...
    foreach ($_SESSION['cesta'] as $prod => $cant) {
        ...
        $html = '
        <div class="producte-carrito-container" id="producte-carrito-container-'.$product[0]['id'].'">
        ...
        '. $select_options[0] . $select_options[1] . $select_options[2] . $select_options[3] . $select_options[4] . ' </select>
